...
using hls::sim::Byte;
extern "C" void fir(volatile void *, short, char);
extern "C" void apatb_fir_hw(volatile void * __xlx_apatb_param_y, short __xlx_apatb_param_x, char __xlx_apatb_param_switch_var) {
using hls::sim::createStream;
  // DUT call
  fir(__xlx_apatb_param_y, __xlx_apatb_param_x, __xlx_apatb_param_switch_var);
}
