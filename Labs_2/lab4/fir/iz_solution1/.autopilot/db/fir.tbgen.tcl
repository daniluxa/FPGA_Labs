...
set C_modelArgMapList {[ 
	{ "Name" : "y", "interface" : "axi_slave", "bundle":"fir_io","type":"ap_vld","bitwidth" : 16, "direction" : "WRITEONLY", "offset" : {"out":16}, "offset_end" : {"out":23}} , 
 	...
 	{ "Name" : "switch_var", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} ]}
# RTL Port declarations: 
set portNum 21
set portList { 
	{ ap_clk sc_in sc_logic 1 clock -1 } 
	{ ap_rst_n sc_in sc_logic 1 reset -1 active_low_sync } 
	{ switch_var sc_in sc_lv 1 signal 2 } 
...
set NewPortList {[ 
	...
	{ "name": "interrupt", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "fir_io", "role": "interrupt" } }, 
 	...
 	{ "name": "switch_var", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "switch_var", "role": "default" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "7", "8", "9"],
		...
		"Port" : [
			...
			{"Name" : "switch_var", "Type" : "None", "Direction" : "I"},
			{"Name" : "shift_reg", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_fir_Pipeline_loop_fu_90", "Port" : "shift_reg", "Inst_start_state" : "6", "Inst_end_state" : "7"}]},
			{"Name" : "c1", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_fir_Pipeline_loop_fu_90", "Port" : "c1", "Inst_start_state" : "6", "Inst_end_state" : "7"}]},
			{"Name" : "c2", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_fir_Pipeline_loop_fu_90", "Port" : "c2", "Inst_start_state" : "6", "Inst_end_state" : "7"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.shift_reg_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_fir_Pipeline_loop_fu_90", "Parent" : "0", "Child" : ["3", "4", "5", "6"],
	...
	{"ID" : "3", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_fir_Pipeline_loop_fu_90.c1_U", "Parent" : "2"},
	{"ID" : "4", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_fir_Pipeline_loop_fu_90.c2_U", "Parent" : "2"},
	{"ID" : "5", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_fir_Pipeline_loop_fu_90.mac_muladd_16s_16s_37s_37_4_1_U1", "Parent" : "2"},
	{"ID" : "6", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_fir_Pipeline_loop_fu_90.flow_control_loop_pipe_sequential_init_U", "Parent" : "2"},
	{"ID" : "7", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fir_io_s_axi_U", "Parent" : "0"},
	{"ID" : "8", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_28s_16s_28_3_1_U9", "Parent" : "0"},
	{"ID" : "9", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_13s_16s_31s_31_4_1_U10", "Parent" : "0"}]}
...
set ArgLastReadFirstWriteLatency {
	fir {
		...
		switch_var {Type I LastRead 1 FirstWrite -1}
		shift_reg {Type IO LastRead -1 FirstWrite -1}
		c1 {Type I LastRead -1 FirstWrite -1}
		c2 {Type I LastRead -1 FirstWrite -1}}
	fir_Pipeline_loop {
		sext_ln21 {Type I LastRead 0 FirstWrite -1}
		switch_var {Type I LastRead 0 FirstWrite -1}
...
set Spec2ImplPortList { 
	switch_var { ap_none {  { switch_var in_data 0 1 } } }
}
