...
`define AESL_DEPTH_switch_var 1
`define AUTOTB_TVIN_x  "../tv/cdatafile/c.fir.autotvin_x.dat"
`define AUTOTB_TVIN_switch_var  "../tv/cdatafile/c.fir.autotvin_switch_var.dat"
`define AUTOTB_TVIN_x_out_wrapc  "../tv/rtldatafile/rtl.fir.autotvin_x.dat"
`define AUTOTB_TVIN_switch_var_out_wrapc  "../tv/rtldatafile/rtl.fir.autotvin_switch_var.dat"
...
// The signal of port switch_var
reg [0: 0] AESL_REG_switch_var = 0;
assign switch_var = AESL_REG_switch_var;
initial begin : read_file_process_switch_var
    integer fp;
    integer err;
    integer ret;
    integer proc_rand;
    ...
    transaction_idx = 0;
    wait(AESL_reset === 1);
    fp = $fopen(`AUTOTB_TVIN_switch_var,"r");
    if(fp == 0) begin       // Failed to open file
        $display("Failed to open file \"%s\"!", `AUTOTB_TVIN_switch_var);
    ...
    while (token != "[[[/runtime]]]") begin
        ...
        if(token != "[[/transaction]]") begin
            ret = $sscanf(token, "0x%x", AESL_REG_switch_var);
              if (ret != 1) begin
...
reg end_switch_var;
reg [31:0] size_switch_var;
reg [31:0] size_switch_var_backup;
reg end_y;
reg [31:0] size_y;
