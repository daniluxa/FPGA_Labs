...
#define AUTOTB_TVOUT_switch_var "../tv/cdatafile/c.fir.autotvout_switch_var.dat"
...
extern "C"
void fir_hw_stub_wrapper(void*, hls::sim::Byte<2>, hls::sim::Byte<1>);

extern "C"
void apatb_fir_hw(void* __xlx_apatb_param_y, hls::sim::Byte<2> __xlx_apatb_param_x, hls::sim::Byte<1> __xlx_apatb_param_switch_var)
{
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_switch_var),
#endif
  };
  port2.param = &__xlx_apatb_param_switch_var;
  ...
  try {
    ...
    fir_hw_stub_wrapper(__xlx_apatb_param_y, __xlx_apatb_param_x, __xlx_apatb_param_switch_var);
