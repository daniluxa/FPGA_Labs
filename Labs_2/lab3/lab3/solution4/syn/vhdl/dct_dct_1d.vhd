...
begin
    ...
    src_address1_assign_proc : process(ap_CS_fsm_state1, ap_CS_fsm_state2, ap_CS_fsm_state3, ap_CS_fsm_state4, zext_ln30_fu_174_p1, tmp_3_cast_fu_195_p1, tmp_5_cast_fu_215_p1, tmp_7_cast_fu_235_p1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
            ...
            src_address1 <= zext_ln30_fu_174_p1(6 - 1 downto 0);
        else 
            src_address1 <= "XXXXXX";
        end if; 
    end process;
