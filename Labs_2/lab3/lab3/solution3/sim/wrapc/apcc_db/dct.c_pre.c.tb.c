...
void dct_1d(signed short *llvm_cbe_src, signed short *llvm_cbe_dst) {
  ...
  static  unsigned long long aesl_llvm_cbe_exitcond2_count = 0;
...
printf("\n\{ BEGIN @apatb_dct_sw\n");
if (AESL_DEBUG_TRACE)
printf("\n  tail call void bitcast (void (...)* @refine_signal_handler to void ()*)() nounwind, !dbg !6 for 0x%I64xth hint within @apatb_dct_sw  --> \n", ++aesl_llvm_cbe_1182_count);
