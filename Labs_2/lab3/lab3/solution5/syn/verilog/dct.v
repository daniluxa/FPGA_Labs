...
(* CORE_GENERATION_INFO="dct_dct,hls_ip_2023_1,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=6.508000,HLS_SYN_LAT=578,HLS_SYN_TPT=none,HLS_SYN_MEM=3,HLS_SYN_DSP=0,HLS_SYN_FF=1363,HLS_SYN_LUT=1890,HLS_VERSION=2023_1}" *)
...
wire   [2:0] trunc_ln58_fu_458_p1;
reg   [2:0] trunc_ln58_reg_527;
wire    ap_CS_fsm_state3;
wire   [0:0] icmp_ln58_fu_462_p2;
...
wire   [2:0] trunc_ln69_fu_499_p1;
reg   [2:0] trunc_ln69_reg_622;
wire    ap_CS_fsm_state7;
wire   [0:0] icmp_ln69_fu_503_p2;
...
wire   [63:0] zext_ln58_fu_446_p1;
wire   [63:0] zext_ln69_fu_487_p1;
reg   [3:0] i_fu_68;
wire   [3:0] add_ln58_fu_468_p2;
reg   [3:0] i_1_fu_148;
wire   [3:0] add_ln69_fu_509_p2;
reg   [11:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_CS_fsm_state7) & (icmp_ln69_fu_503_p2 == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((icmp_ln58_fu_462_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln58_fu_462_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
        i_1_fu_148 <= 4'd0;
    end else if (((1'b1 == ap_CS_fsm_state7) & (icmp_ln69_fu_503_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
        i_fu_68 <= 4'd0;
    end else if (((icmp_ln58_fu_462_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        buf_2d_in_10_address0 = zext_ln58_fu_446_p1;
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        buf_2d_in_11_address0 = zext_ln58_fu_446_p1;
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
        buf_2d_in_11_address0 = grp_dct_Pipeline_RD_Loop_Row_RD_Loop_Col_fu_344_buf_2d_in_11_address0;
    end else begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        buf_2d_in_12_address0 = zext_ln58_fu_446_p1;
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
        buf_2d_in_12_address0 = grp_dct_Pipeline_RD_Loop_Row_RD_Loop_Col_fu_344_buf_2d_in_12_address0;
    end else begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        buf_2d_in_13_address0 = zext_ln58_fu_446_p1;
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
        buf_2d_in_13_address0 = grp_dct_Pipeline_RD_Loop_Row_RD_Loop_Col_fu_344_buf_2d_in_13_address0;
    end else begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        buf_2d_in_14_address0 = zext_ln58_fu_446_p1;
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
        buf_2d_in_14_address0 = grp_dct_Pipeline_RD_Loop_Row_RD_Loop_Col_fu_344_buf_2d_in_14_address0;
    end else begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        buf_2d_in_8_address0 = zext_ln58_fu_446_p1;
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
        buf_2d_in_8_address0 = grp_dct_Pipeline_RD_Loop_Row_RD_Loop_Col_fu_344_buf_2d_in_8_address0;
    end else begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        buf_2d_in_9_address0 = zext_ln58_fu_446_p1;
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
        buf_2d_in_9_address0 = grp_dct_Pipeline_RD_Loop_Row_RD_Loop_Col_fu_344_buf_2d_in_9_address0;
    end else begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        buf_2d_in_address0 = zext_ln58_fu_446_p1;
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
        buf_2d_in_address0 = grp_dct_Pipeline_RD_Loop_Row_RD_Loop_Col_fu_344_buf_2d_in_address0;
    end else begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state7)) begin
        col_inbuf_1_address0 = zext_ln69_fu_487_p1;
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state7)) begin
        col_inbuf_2_address0 = zext_ln69_fu_487_p1;
    end else if ((1'b1 == ap_CS_fsm_state6)) begin
        col_inbuf_2_address0 = grp_dct_Pipeline_Xpose_Row_Outer_Loop_Xpose_Row_Inner_Loop_fu_366_col_inbuf_2_address0;
    end else begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state7)) begin
        col_inbuf_3_address0 = zext_ln69_fu_487_p1;
    end else if ((1'b1 == ap_CS_fsm_state6)) begin
        col_inbuf_3_address0 = grp_dct_Pipeline_Xpose_Row_Outer_Loop_Xpose_Row_Inner_Loop_fu_366_col_inbuf_3_address0;
    end else begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state7)) begin
        col_inbuf_4_address0 = zext_ln69_fu_487_p1;
    end else if ((1'b1 == ap_CS_fsm_state6)) begin
        col_inbuf_4_address0 = grp_dct_Pipeline_Xpose_Row_Outer_Loop_Xpose_Row_Inner_Loop_fu_366_col_inbuf_4_address0;
    end else begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state7)) begin
        col_inbuf_5_address0 = zext_ln69_fu_487_p1;
    end else if ((1'b1 == ap_CS_fsm_state6)) begin
        col_inbuf_5_address0 = grp_dct_Pipeline_Xpose_Row_Outer_Loop_Xpose_Row_Inner_Loop_fu_366_col_inbuf_5_address0;
    end else begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state7)) begin
        col_inbuf_6_address0 = zext_ln69_fu_487_p1;
    end else if ((1'b1 == ap_CS_fsm_state6)) begin
        col_inbuf_6_address0 = grp_dct_Pipeline_Xpose_Row_Outer_Loop_Xpose_Row_Inner_Loop_fu_366_col_inbuf_6_address0;
    end else begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state7)) begin
        col_inbuf_7_address0 = zext_ln69_fu_487_p1;
    end else if ((1'b1 == ap_CS_fsm_state6)) begin
        col_inbuf_7_address0 = grp_dct_Pipeline_Xpose_Row_Outer_Loop_Xpose_Row_Inner_Loop_fu_366_col_inbuf_7_address0;
    end else begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state7)) begin
        col_inbuf_address0 = zext_ln69_fu_487_p1;
    end else if ((1'b1 == ap_CS_fsm_state6)) begin
        col_inbuf_address0 = grp_dct_Pipeline_Xpose_Row_Outer_Loop_Xpose_Row_Inner_Loop_fu_366_col_inbuf_address0;
    end else begin
...
assign add_ln58_fu_468_p2 = (i_fu_68 + 4'd1);

assign add_ln69_fu_509_p2 = (i_1_fu_148 + 4'd1);
...
assign icmp_ln58_fu_462_p2 = ((i_fu_68 == 4'd8) ? 1'b1 : 1'b0);

assign icmp_ln69_fu_503_p2 = ((i_1_fu_148 == 4'd8) ? 1'b1 : 1'b0);
...
assign trunc_ln58_fu_458_p1 = i_fu_68[2:0];

assign trunc_ln69_fu_499_p1 = i_1_fu_148[2:0];

assign zext_ln58_fu_446_p1 = i_fu_68;

assign zext_ln69_fu_487_p1 = i_1_fu_148;
