...
architecture behav of dct is 
    ...
    "dct_dct,hls_ip_2023_1,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=6.508000,HLS_SYN_LAT=577,HLS_SYN_TPT=443,HLS_SYN_MEM=3,HLS_SYN_DSP=0,HLS_SYN_FF=1367,HLS_SYN_LUT=1690,HLS_VERSION=2023_1}";
