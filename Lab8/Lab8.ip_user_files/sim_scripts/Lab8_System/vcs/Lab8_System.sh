...
#
# Script generated by Vivado on Sun Oct 06 12:40:42 +0300 2024
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : Lab8_System.sh
...
#
# Usage        : Lab8_System.sh
#                Lab8_System.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                Lab8_System.sh [-reset_run]
#                Lab8_System.sh [-reset_log]
#                Lab8_System.sh [-help]
#
...
#                script (type 'Lab8_System.sh -help' for more information).
#
...
# script info
echo -e "Lab8_System.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./Lab8_System.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../Lab7.gen/sources_1/bd/Lab8_System/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../Lab7.gen/sources_1/bd/Lab8_System/ipshared/aed8/hdl" +incdir+"../../../../Lab7.gen/sources_1/bd/Lab8_System/ipshared/ec67/hdl" +incdir+"../../../../Lab7.gen/sources_1/bd/Lab8_System/ipshared/aed8/hdl" +incdir+"F:/Xilinx/Vitis/Vivado/2023.1/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.Lab8_System xil_defaultlib.glbl -o Lab8_System_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./Lab8_System_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key Lab8_System_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc Lab8_System_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./Lab8_System.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: Lab8_System.sh [-help]\n\
Usage: Lab8_System.sh [-step]\n\
Usage: Lab8_System.sh [-lib_map_path]\n\
Usage: Lab8_System.sh [-reset_run]\n\
Usage: Lab8_System.sh [-reset_log]\n\
Usage: Lab8_System.sh [-keep_index]\n\
Usage: Lab8_System.sh [-noclean_files]\n\n\
