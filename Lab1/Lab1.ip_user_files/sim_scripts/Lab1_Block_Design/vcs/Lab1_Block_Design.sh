...
#
# Script generated by Vivado on Sat Oct 05 19:09:44 +0300 2024
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : Lab1_Block_Design.sh
...
#
# Usage        : Lab1_Block_Design.sh
#                Lab1_Block_Design.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                Lab1_Block_Design.sh [-reset_run]
#                Lab1_Block_Design.sh [-reset_log]
#                Lab1_Block_Design.sh [-help]
#
...
#                script (type 'Lab1_Block_Design.sh -help' for more information).
#
...
# script info
echo -e "Lab1_Block_Design.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./Lab1_Block_Design.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../Lab1.gen/sources_1/bd/Lab1_Block_Design/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../Lab1.gen/sources_1/bd/Lab1_Block_Design/ipshared/aed8/hdl" +incdir+"../../../../Lab1.gen/sources_1/bd/Lab1_Block_Design/ipshared/ec67/hdl" +incdir+"../../../../Lab1.gen/sources_1/bd/Lab1_Block_Design/ipshared/aed8/hdl" +incdir+"F:/Xilinx/Vitis/Vivado/2023.1/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.Lab1_Block_Design xil_defaultlib.glbl -o Lab1_Block_Design_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./Lab1_Block_Design_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key Lab1_Block_Design_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc Lab1_Block_Design_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./Lab1_Block_Design.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: Lab1_Block_Design.sh [-help]\n\
Usage: Lab1_Block_Design.sh [-step]\n\
Usage: Lab1_Block_Design.sh [-lib_map_path]\n\
Usage: Lab1_Block_Design.sh [-reset_run]\n\
Usage: Lab1_Block_Design.sh [-reset_log]\n\
Usage: Lab1_Block_Design.sh [-keep_index]\n\
Usage: Lab1_Block_Design.sh [-noclean_files]\n\n\
